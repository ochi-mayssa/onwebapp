...
def get_role_nav_items(user):
    ...
    if role in (ROLE_ADMIN, ROLE_SUPERVISOR):
        ...
        nav.extend([
            ...
            {
                'url': reverse('branding:design_library') + '?tab=resources',
                'label': 'Resources',
        ...
        nav.extend([
            ...
            {
                'url': reverse('branding:design_library') + '?tab=templates',
                'label': 'Templates',
...
def get_role_dropdown_items(user):
    ...
    if role in (ROLE_ADMIN, ROLE_SUPERVISOR):
        items.extend([
            ...
            {'section': 'Designer'},
            {'url': reverse('branding:design_library') + '?tab=resources', 'label': 'Resources', 'icon': 'fa-solid fa-book'},
            {'url': reverse('branding:design_library') + '?tab=templates', 'label': 'Templates', 'icon': 'fa-solid fa-file-lines'},
